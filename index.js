...
class Part {
    ...
    async load() {
        ...
        this.parseXml(xmlDoc.firstChild || xmlDoc.firstElementChild);
    }
    save() {
...
class OpenXmlPackage {
    ...
    async loadRelationships(path = null) {
        ...
        if (!txt)
            return null;
        let parsedDoc = this.parseXmlDocument(txt)
        let firstElementChild = parsedDoc.firstChild || parsedDoc.firstElementChild;
        return txt ? parseRelationships(firstElementChild, this.xmlParser) : null;
    }
